...
require 'rest-client'
 ...
 NotFound = Class.new(RuntimeError)
  ...
  # Raised when an API request uses an invalid access token  Unauthorized = Class.new(RuntimeError)

  # Raised when an API request is missing required data  MissingRequiredData = Class.new(RuntimeError)
  ...
  # initializes the api with access token
    ...
    unless access_token.nil?
      Rails.logger.info "> GitHubApi: init with token!"
